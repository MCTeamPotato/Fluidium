...
public class FluidiumConfig {
    ...
    public static final Set<ResourceLocation> ALWAYS_TICK_FLUIDS = CONFIG.getStream("FluidsThatAlwaysTick(RegistryName)", String.class).map(ResourceLocation::new).collect(Collectors.toSet());
